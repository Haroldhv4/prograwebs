          ...
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
              <div className="flex justify-center lg:justify-start items-center grow basis-0">
                <div className="text-white mr-2 text-6xl">
                  <img src="src/assets/images/logo.png" alt="" style={{ height: "40px;"}} />
                </div>
              ...
              Somos una empresa que busca ser líder en el desarrollo de software, dedicada a transformar ideas en soluciones digitales innovadoras
                <a
            ...
            <div className="w-full lg:w-2/3  lg:pl-16 hidden lg:flex flex-wrap justify-between">
              <div className="w-full md:w-1/3 lg:w-auto mb-16 md:mb-0">
                <h3 className="mb-6 text-2xl font-bold text-white">Productos</h3>
                <ul>
