      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-customDarkBg1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            ...
            En la era digital actual, tener una presencia en línea sólida es fundamental para el éxito de cualquier empresa. Nuestras páginas web no solo ofrecen una presencia digital, sino que también son una poderosa herramienta para potenciar tu éxito en el mundo digital.
            </p>
            <div
